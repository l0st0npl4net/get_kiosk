...
sudo lpadmin -x VKPIII_VCOM -E -v serial:/dev/vcom_printer?baud=115200 -P /tmp/get_kiosk-main/app/fp/driver/Custom_VKP80III_3_VCOM/KPOS_Printer/filter/VKP80.ppd
