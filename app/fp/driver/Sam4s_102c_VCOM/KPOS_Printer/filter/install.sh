...
sudo lpadmin -p SAM4S_VCOM -E -v serial:/dev/vcom_printer?baud=115200 -P /tmp/get_kiosk-main/app/fp/driver/Sam4s_102c_VCOM/KPOS_Printer/filter/SAM4s_gcube-102.ppd
