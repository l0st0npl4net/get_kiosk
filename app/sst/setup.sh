...
sudo wget -O /tmp/libtiff5-main.deb https://snapshot.debian.org/archive/debian/20221124T210835Z/pool/main/t/tiff/libtiff5_4.4.0-6_amd64.deb
...
sudo dpkg -i /tmp/libtiff5-main.deb
